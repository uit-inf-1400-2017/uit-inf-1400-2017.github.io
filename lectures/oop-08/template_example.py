...
"""
Template pattern example (Chapter 8 in the OOP book). 
Slightly modified example to get something we can play with. 
"""
...
def init_db():
    """Set up initial database if it doesn't exist already"""
